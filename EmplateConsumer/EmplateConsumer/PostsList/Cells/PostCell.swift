...
class PostCell: UITableViewCell {
    ...
    func setData(model:PostsModel) {
        ...
        consPostImageHeight.constant = Utilities.shared.getWidth_HeightFactor(viewWidth: self.frame.width, width: CGFloat(model.thumbnail?.width ?? Constants.postsImageDefaultHeight), height: CGFloat(model.thumbnail?.height ?? Constants.postsImageDefaultHeight))
